        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    brand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    trailerType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    licensePlate = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    registration = table.Column<DateTime>(type: "datetime2", nullable: false),
                    nextServiceDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    specification = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverLicence_Driver_driverId",
                        column: x => x.driverId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    locationOrigin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    locationDestination = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    companyName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    loadWeight = table.Column<double>(type: "float", nullable: false),
                    loadLength = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferUser", x => x.id);
                    table.ForeignKey(
                        name: "FK_OfferUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferUser_Offer_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferUser_OfferId",
                table: "OfferUser",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferUser_UserId",
                table: "OfferUser",
                column: "UserId");
